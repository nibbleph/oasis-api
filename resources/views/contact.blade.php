                        ...
                        <table cellpadding="0" cellspacing="0" border="0" width="88%" style="width: 88% !important; min-width: 88%; max-width: 88%;">
                           <tr>
                              <td align="center" valign="top">
                                 ...
                                 <a href="https://www.oasisdentalcallcenter.com/" style="display: block; max-width: 192px;">
                                 <img src="https://www.oasisdentalcallcenter.com/assets/logo/oasis-removebg-preview.png" alt="Oasis" width="192" border="0" style="display: block; width: 192px;" />
                                 </a>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" width="88%" style="width: 88% !important; min-width: 88%; max-width: 88%;">
                           <tr>
                              <td align="left" valign="top">
                                 ...
                                 <span class="mob_title1" style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 52px; line-height: 55px; font-weight: 300; letter-spacing: -1.5px;">
                                 Your message has been sent!
                                 </span>
                                 </font>
                                 <div class="min_pad" style="height: 32px; line-height: 32px; font-size: 30px;">&nbsp;</div>
                                 <p style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #000000; font-size: 20px; line-height: 28px;">
                                    Good day {{$name}} <strong>({{$email}})</strong>
                                 </p>

                                 <p style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #000000; font-size: 20px; line-height: 28px;">
                                    Thank you for reaching out to us, We will get back to you shortly. <div class="min_pad" style="height: 32px; line-height: 32px; font-size: 30px;">&nbsp;</div>

                                    <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #000000; font-size: 20px; line-height: 28px;">On the other hand, You can review your message below.</span>
                                 </p>
